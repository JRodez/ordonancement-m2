...
DWORD RTDS_Start( void * dummy )
  ...
  /* PROCESS CREATIONS */
  RTDS_STARTUP_PROCESS_CREATE("Th_Robot_Alim", RTDS_process_Th_Robot_Alim, Th_Robot_Alim, RTDS_DEFAULT_PROCESS_PRIORITY);
  RTDS_STARTUP_PROCESS_CREATE("gestionConvoyeur", RTDS_process_gestionConvoyeur, gestionConvoyeur, RTDS_DEFAULT_PROCESS_PRIORITY);
  RTDS_STARTUP_PROCESS_CREATE("Th_Dialogue", RTDS_process_Th_Dialogue, Th_Dialogue, RTDS_DEFAULT_PROCESS_PRIORITY);
  RTDS_STARTUP_PROCESS_CREATE("Th_Robot_Ret", RTDS_process_Th_Robot_Ret, Th_Robot_Ret, RTDS_DEFAULT_PROCESS_PRIORITY);
  /* *************************************************************** */
